...
export const metadata: Metadata = {
  title: "Electricity Calculator - K Toolkit",
  description:
          ...
          <div className="mb-8">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-heading-1">Electricity Calculator</h1>
                  <Badge variant="secondary" className="mt-1">
                    Utilities
                  </Badge>
                </div>
              </div>
              <p className="text-body-large text-muted-foreground max-w-2xl">Calculate KPLC token units and costs</p>
            </div>
          </div>
